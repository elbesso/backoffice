...
public enum State {
    ...
    State(String unnabreviated, String ANSIabbreviation, String ISOabbreviation) {
    ...
    public void setUnnabreviated(String unnabreviated) {
        this.unnabreviated = unnabreviated;
    }
    ...
    public void setANSIabbreviation(String ANSIabbreviation) {
        this.ANSIabbreviation = ANSIabbreviation;
    }
